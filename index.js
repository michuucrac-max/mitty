...
// =============================
// 🔐 Variables de entorno (Render Environments)
// =============================
...
client.on("messageCreate", async (message) => {
  ...
  const canalDM = message.channel.type === 1; // DMs
      ...
      messages: [
        {
          role: "system",
          content: `
Eres Softti Tales, una bot kawaii, dulce y amable con personalidad alegre. 
Habla como una chica tierna, usa emojis lindos, evita temas negativos o inapropiados.
Si te saludan, responde con energía; si te piden ayuda, sé muy amable. 💖
          `
        },
    ...
    await message.reply("😿 Algo salió mal, nyan~ inténtalo más tarde uwu");
  }
});
...
// =============================
// 🌈 Estados dinámicos (Discord.js v15 usa clientReady)
// =============================
