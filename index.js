...
async function softiAI(prompt, username) {
    try {
        ...
        if (Math.random() < 0.40) {
            estilo = "habla como una bebé furry, diciendo uwu, añadiendo terminaciones tiernas y actuando como pequeña";
        }
        ...
        return "owww… creo que mi pancita de gatita falló uwu >~<";
    }
}
