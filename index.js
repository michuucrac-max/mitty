...
if (!TOKEN) console.error('❌ TOKEN de Discord no definido en environment variables.');
if (!CLIENT_ID) console.warn('⚠️ CLIENT_ID no definido. Comandos globales no se registrarán.');
if (!OPENAI_API_KEY) console.warn('⚠️ OPENAI_API_KEY no definido. La IA no funcionará.');
