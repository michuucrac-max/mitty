// index.js — limpio y funcional + OpenAI kawaii/furry/uwu
...
client.on('messageCreate', async message => {
  try {
    ...
    if (contenido.startsWith('!')) {
      ...
      let found;
      if (Array.isArray(cmd)) found = cmd.find(c => c.name.toLowerCase() === name);
      else if (cmd && typeof cmd === 'object') found = cmd[name];
    ...
    // Menciones y DMs → respuesta kawaii OpenAI
